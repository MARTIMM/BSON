...
#-------------------------------------------------------------------------------
# 
my BSON::Encode-Tools $et .= new;
my BSON::Decode-Tools $dt .= new;
my $index;
#-------------------------------------------------------------------------------
# int32 decoding
#
...
my Int $v = $dt.dec_int32( $b.list, $index);
is( $v, 0, 'int32: dec N = 0');

$index = 0;
$b = Buf.new( 0xFF xx 4 );
$v = $dt.dec_int32( $b.list, $index);
...
# Too large encoding
#
$b = $et.enc_int64(0x7fffffff_ffffffff + 1);
